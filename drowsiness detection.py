...
root.title(" "*190+"---DROWSINESS DETECTION---")
# lbl = tk.Lable(root, text="DROWSINESS DETECTION SYSTEM", font=('times', 35,'bolt'), height=1, width=32, bg="red",fg='White')
# lbl.place(x=300,y=5)
...
lbl1=tk.Label(root, text="DROWSINESS DETECTION SYSTEM", font=('times', 35,'bold'), height=1, width=60, bg="#000080",fg='White')
lbl1.place(x=0,y=0)
...
def Drowsiness():
    ...
    while(True):
        ...
        if returnValue[0]:
            print(returnValue)
            print("Yawn detected!")
            #cv2.putText(frame,"Yawn detected!",(10,20), font, 1,(255,255,255),1,cv2.LINE_AA)
            sound.play()
...
button1 = tk.Button(root,text="Drowsiness", command= Drowsiness,width=30,height=2,font="bold",fg="white",bg="red")
button1.place(x=100 , y=100)

button2 = tk.Button(root,text="Exit", command= Exit,width=30,height=2,font="bold",fg="white",bg="red")
